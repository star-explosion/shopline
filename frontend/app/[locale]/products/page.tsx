...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      languages: { zh: `${BASE}/zh/products`, en: `${BASE}/en/products`, ja: `${BASE}/ja/products` },
    },
    ...
    <div>
      ...
      <div className="pt-24 pb-12 bg-white border-b border-[#E2DDD6]">
        <div className="max-w-6xl mx-auto px-6 lg:px-10">
          ...
          <h1 className="font-display text-4xl md:text-5xl text-[#111111] mb-4">{t("collection")}</h1>
          <p className="text-[#6B6B6B] text-sm max-w-lg leading-relaxed">{t("collectionDesc")}</p>
        </div>
      </div>

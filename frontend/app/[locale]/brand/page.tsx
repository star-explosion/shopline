...
const BASE = process.env.NEXT_PUBLIC_SITE_URL || "https://royalbaland.com";
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    ...
    alternates: {
      languages: { zh: `${BASE}/zh/brand`, en: `${BASE}/en/brand`, ja: `${BASE}/ja/brand` },
    },
    openGraph: { title: t("brandTitle"), description: t("brandDesc") },
  };
}
...
const engineeringCases = [
  ...
  { name: "肇庆温德姆至尊酒店", desc: "温德姆集团旗下" },
  { name: "佛山长华温德姆酒店", desc: "温德姆集团旗下" },
  { name: "株洲温德姆花园酒店", desc: "温德姆集团旗下" },
  { name: "遵义帝景世尊酒店", desc: "高端商务酒店" },
  { name: "桂林大公馆", desc: "桂林精品酒店" },
  { name: "郎酒集团天宝洞度假酒店", desc: "企业集团度假项目" },
];
    ...
    <div>
      <div className="relative pt-32 pb-24 bg-cover bg-center bg-no-repeat" style={{ backgroundImage: "url('https://images.unsplash.com/photo-1588046130717-0eb0c9a3ba15?w=1600&q=70')" }}>
        ...
        <div className="relative max-w-6xl mx-auto px-6 lg:px-10 text-white">
          ...
          <p className="text-white/70 text-sm leading-relaxed max-w-lg">惠州市皇室百兰寝具有限公司（Royal Baland），专业从事酒店床垫工程项目，是一家集研发、生产、销售高品质床垫及软床系列产品为一体的生产型企业，专注于人类睡眠文化发展事业。</p>
        </div>
      </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              <div className="space-y-4 text-sm text-[#6B6B6B] leading-loose">
                ...
                <p>企业快速发展得益于先进的技术与团队力量：技术方面，选择了国际上最优秀的合作伙伴——美国礼恩派（专业床垫设备及材料商）、美国杜邦特立珑纺织、德国恩科远红外线科技公司、韩国颐康生化科技公司（抗菌防螨剂中心）、比利时天然乳胶制造商、比利时贝卡特纺织布料商、中国医学睡眠研究中心等。</p>
                <p>皇室百兰以&ldquo;以人为本&rdquo;为管理方针，产品的市场份额不断扩大，销售网络遍布国内各大中城市及港澳台地区，与众多国际知名酒店深入合作。</p>
              </div>
            </div>
